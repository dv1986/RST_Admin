...
export class TypeListComponent implements OnInit {
    ...
    onAddNew() {
        ...
        this.modalRef = this.modalService.show(TypeAddComponent, { initialState: initialState, backdrop: 'static', keyboard: false, animated: true, ignoreBackdropClick: true, class: "modal-md" })
        if (this.modalRef) {
    ...
    initGrid() {
        this.gridOptions.columnDefs = [
            ...
            { headerName: 'Type', field: 'typeName', sortable: true, filter: true, type: ['editableColumn'] },
