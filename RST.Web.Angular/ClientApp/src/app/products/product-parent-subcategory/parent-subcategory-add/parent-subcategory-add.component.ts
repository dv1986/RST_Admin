...
@Component({
    selector: 'parent-subcategory-add',
    templateUrl: './parent-subcategory-add.component.html'
})
export class ParentSubCategoryAddComponent implements OnInit {
    ...
    initForm() {
        this.form = new FormGroup({
            ...
            'subCategoryParentName': new FormControl('', Validators.required),
    ...
    onSubmit() {
        ...
        this.model.subCategoryParentName = this.form.controls['subCategoryParentName'].value;
        ...
        this._productService.addProductSubCategoryParent(this.model).subscribe(result => {
            if (result.state == 0) {
